...
|  Tarih       |     Ana Konu       | Alt Baslik  | Alt Baslik  |
| ------------- |:-------------:| -----:|-----:|
...
| 28.03.2019  | Yapay Ogrenme | Gradyan Inis |[Lineer Regresyon](https://nbviewer.jupyter.org/github/uzay00/KaVe-Egitim/blob/master/YapayOgrenme/LineerRegresyon/LineerRegresyon.ipynb) |
